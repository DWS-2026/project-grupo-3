...
3. **Entidad 3**: Carrito de la compra
4. **Entidad 4**: Plantas
5. **Entidad 5**: Pedidos
6. **Entidad 6**: Comentarios

**Relaciones entre entidades:**
- Usuario - Pedido: Un usuario puede realizar múltiples pedidos y cada pedido pertenece a un único usuario (1:N)
- Usuario - Carrtio de la compra: un usuario tiene un único carrito de la compra y el carrito de la compra pertenece a un único usuario (1:1)
...
- Carrito de la compra - Pedido: un carrito de la compra pertenece a un pedido y un pedido pertenece a un carrito de la compra (1:1)
...
![Diagrama de Navegación](src/main/resources/static/assets/images/navigation-diagram.jpg)
...
![Página Principal](src/main/resources/static/assets/images/pantallas/comunes/home-page.png)
...
![Página de inicio de sesión](src/main/resources/static/assets/images/pantallas/comunes/sign-in.png)
...
![Página del catálogo de plantas](src/main/resources/static/assets/images/pantallas/usuarioNoRegistrado/catalogoPlantas.png)
...
![Página del catálogo de productos](src/main/resources/static/assets/images/pantallas/comunes/catalogoProductos.png)
...
![Página del carrito de la compra](src/main/resources/static/assets/images/pantallas/comunes/carritoCompra.png)
...
#### **6. Pago**
![Página del pago](src/main/resources/static/assets/images/pantallas/comunes/pago.png)
...
![Página de inicio para usuario registrado](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/home-page.png)
...
![Página del catálogo de plantas para usuario registrado](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/catalogoPlantas.png)
...
#### **9. Editar planta**
![Página de edición para una planta](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/editarPlanta.png)
...
![Página del pedido del usuario](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/mispedidos.png)
...
![Página del perfil del usuario](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/perfil.png)
...
![Página de editar perfil del usuario](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/editarPerfil.png)
...
![Página de editar perfil del usuario](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/configuracion.png)
...
![Página de registro de una nueva planta](src/main/resources/static/assets/images/pantallas/usuarioRegistrado/nuevaPlanta.png)
...
![Página de inicio para administrador](src/main/resources/static/assets/images/pantallas/admin/home-page.png)
...
![Página de catálogo de productos para administrador](src/main/resources/static/assets/images/pantallas/admin/catalogoProductos.png)
...
![Página del panel de administrador](src/main/resources/static/assets/images/pantallas/admin/panelAdmin.png)
...
![Página de la gestión de usuarios](src/main/resources/static/assets/images/pantallas/admin/gestiosUsuarios.png)
...
![Página de la gestión de productos](src/main/resources/static/assets/images/pantallas/admin/gestionProductos.png)
...
![Página del registro de un nuevo producto](src/main/resources/static/assets/images/pantallas/admin/nuevoProducto.png)
...
#### **21. Editar producto**
![Página de edición de un producto](src/main/resources/static/assets/images/pantallas/admin/editarProducto.png)
...
![Página de edición de un producto](src/main/resources/static/assets/images/pantallas/admin/gestionPedidos.png)
